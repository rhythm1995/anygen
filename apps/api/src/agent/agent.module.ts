...
import { CanvasAgentController } from "./canvas-agent.controller";
...
@Module({
  ...
  controllers: [AgentController, FreeAgentController, CanvasAgentController],
  providers: [AgentService, FreeAgentService, CanvasAgentTurnService],
})
