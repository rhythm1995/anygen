 ...
 * 画布文档/Agent 全量类型（Agent 部分供 Phase C 使用）
 */
...
export type InsertAssetPayload =
    ...
    | { kind: "image"; dataUrl: string; title: string; assetId?: string; width?: number; height?: number; bytes?: number; mimeType?: string; source?: "asset" | "library" }
    | { kind: "video"; url: string; title: string; assetId?: string; width?: number; height?: number; bytes?: number; mimeType?: string; source?: "asset" | "library" }
    | { kind: "audio"; url: string; title: string; assetId?: string; bytes?: number; mimeType?: string; durationMs?: number; source?: "asset" | "library" };
