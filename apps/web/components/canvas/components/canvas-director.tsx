"use client";
/**
 * 3D 导演台容器（D12 Phase D）
 * 来源：vendor/infinite-canvas canvas-director（AGPL-3.0）——iframe + postMessage 协议（storyai:director-*）；
 * 导演台本体为预构建静态应用 public/director（随 vendor 同步，禁手改）。
 */
